/******************************************************************************
 * Header file for LCJV Electronics eIP-10 Development board + SPI LCD        *
 *============================================================================*
 *                                                                            *
 * This header file defines the hardware configuration and options for the    *
 * LJCV Electronics eIP-10 Development Board with a character LCD module      *
 * using the SPI interface and a Microchip MCP23S08 port extender.            *
 *                                                                            *
 ...
 * how to connect the character LCD module can also be obtained at:           *
...
//                     |||||+--------- RB2 = n/c, J1-3
//                     ||||||+-------- RB1 = n/c, J1-1
//                     |||||||+------- RB0 = (MCP23S08 CS), J1-2
#define INIT_TRISB  (0b00000000)
#define INIT_PORTB  (0b00000001)
