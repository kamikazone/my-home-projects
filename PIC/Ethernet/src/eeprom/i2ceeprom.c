 ...
 *============================================================================*
 *                                                                            *
 * The current source code implements a device driver for an external serial  *
 ...
 * 08/10/06 Howard Schlunder  Renamed registers/bits to use C18/C30 style     *
 *                            standard names                                  *
 * 04/25/07 Jorge Amodio      Cleanup and moved to eeeprom directory          *
 *                            added USE_I2CEEPROM macro                       *
 ******************************************************************************/
