/******************************************************************************
 * Header file for LCJV Electronics PICNet1 Development board + LCD (SPI)     *
 *============================================================================*
 *                                                                            *
 * This header file defines the hardware configuration and options for the    *
 * LJCV Electronics PICNet1 Development Board with a character LCD module     *
 * (HD44780 or similar controller) connected via the SPI interface using a    *
 * Microchip MCP23S08 port extender.                                          *
 *                                                                            *
 * Detailed information about the PICNet1 board can be obtained at:           *
 * http://www.ljcv.net/picnet1/                                               *
 *                                                                            *
 * A detailed shcematic of the PICNet1 board and an schematic showing how to  *
 * connect the LCD module can also be obtained at:                            *
