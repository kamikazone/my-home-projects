/******************************************************************************
 * Header file for PIC24FJ64GA002 + nic28 Test Prototype + SPI LCD            *
 *============================================================================*
 *                                                                            *
 ...
 ******************************************************************************/
#ifndef _PIC24FJ64_LCD_H
#define _PIC24FJ64_LCD_H
...
//                          |     |+---- RA3  = Used as OSCO
//                          |     ||+--- RA2  = Used as OSCI
//                          |     |||+-- RA1  = LED2 mapped to LED1_IO
//                     _____|_____||||+- RA0  = LED1 mapped to LED0_IO
#define INIT_TRISA  (0b0000000000000000)
#define INIT_PORTA  (0b0000000000000000)

// PORTB Direction and initial status
//                     +---------------- RB15 = (RP15) Used for UART1 RX
//                     |+--------------- RB14 = (RP14) Used for UART1 TX
//                     ||+-------------- RB13 = n/c
//                     |||+------------- RB12 = MCP23S08 CS
//                     ||||+------------ RB11 = 25LC256 CS
//                     |||||+----------- RB10 = nic 28 CS
...
#define INIT_TRISB  (0b1000001000001100)
...
#define USE_MCP23S08
#define PORTX_CS_IO          (LATBbits.LATB12)
#define PORTX_SPI_IF         (IFS0bits.SPI1IF)
#define PORTX_SSPBUF         (SPI1BUF)
#define PORTX_SPISTAT        (SPI1STAT)
#define PORTX_SPISTATbits    (SPI1STATbits)
#define PORTX_SPICON1        (SPI1CON1)
#define PORTX_SPICON1bits    (SPI1CON1bits)
#define PORTX_SPICON2        (SPI1CON2)
#define PORTX_SPIEN          (SPI1STATbits.SPIEN)
#define PORTX_ADDRESS        (0x00)
#define PORTX_SPICON1_CFG    (0x0137)  // 5.33 MHz
#define PORTX_SPICON2_CFG    (0x0000)
#define PORTX_SPISTAT_CFG    (0x8000)
...
#define ENC_SPICON1_CFG      (0x013b)  // 8 MHz
...
//*****************************************************************************
// Definitions for 25LC256/25LC1024 serial EEPROM
//
#define USE_25LC256
...
#define EEPROM_SPICON1_CFG   (0x0133)  // 4 MHz
